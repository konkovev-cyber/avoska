        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="bg-surface rounded-[2.5rem] border border-border p-8 md:p-12 shadow-sm">
                ...
                <div className="space-y-8 text-muted font-medium leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-foreground mb-4">3. Права и обязанности</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-foreground mb-4">5. Статус проекта</h2>
