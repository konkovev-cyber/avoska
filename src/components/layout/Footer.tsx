            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 text-center md:text-left">
                        <Link prefetch={false} href="/" className="flex items-center gap-1 group">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 text-xs font-semibold text-muted uppercase tracking-wide">
                        <Link prefetch={false} href="/categories" className="hover:text-primary transition-colors">Категории</Link>
                        <Link prefetch={false} href="/help" className="hover:text-primary transition-colors">Помощь</Link>
                        <Link prefetch={false} href="/terms" className="hover:text-primary transition-colors">Оферта</Link>
                        <Link prefetch={false} href="/privacy" className="hover:text-primary transition-colors">Конфиденциальность</Link>
                    </div>
