                ...
                <div className="p-6 space-y-4">
                    {SERVICES.map((service) => (
                        <button
                            ...
                            className="w-full p-4 rounded-3xl border border-border bg-surface hover:border-primary transition-all group flex items-center gap-4 text-left active:scale-[0.98]"
                        >
                            <div className={cn(
                            ...
                            <div className="flex-1">
                                <div className="font-black text-sm uppercase tracking-wide">{service.name}</div>
                                <div className="text-xs text-muted-foreground font-medium mt-0.5">{service.description}</div>
                            </div>
                            <div className="text-right">
                                <div className="text-sm font-black text-primary">{service.price} ₽</div>
                                <div className="text-[9px] font-black uppercase tracking-widest text-muted-foreground mt-1">Купить</div>
                            </div>
                        </button>
                    ))}
                </div>
